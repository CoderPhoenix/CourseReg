...
try{
           ...
           int r=st.executeUpdate("delete from faculty where fname='"+fname+"'");
if(r>=1)
	{
	con.commit();
	con.setAutoCommit(false);
...
stmt.executeUpdate("update admin set fname=null where fname='"+fname+"'");
con.commit();
 out.print("<div class='circle'><span>");
		out.print("<h3>Deletion successful</h3>");
