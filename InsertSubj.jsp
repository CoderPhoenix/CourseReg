...
<br>
<div class='circle'>
<form action="InsertSubj2.jsp" method=post>
<h2 align=center> Insert New Subject </h2><hr>
Subject name
</br></br>
<input type=text  maxlength=40 name="sn" required>
</br></br>
Faculty name
</br></br>
<select name="fn">
...
ResultSet rs=st.executeQuery("select fname from faculty");
while(rs.next())
{
  ...
  {out.println("Exception at InsertSubj.jsp");}
%>
</select>
</br></br>
Course year
<select style="margin-left:25%"name=cy>
...
Course semester
<select style="margin-left:10%"name=cs>
<option value=1>1</option>
<option value=2>2</option>
</select>
</br></br>
