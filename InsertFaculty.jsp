...
<hr>
<form action="InsertFacultydb.jsp" method="post">
Faculty-id
</br></br>
<input  type="text" size="40" maxlength="10" name="fid" required>
</br></br>
Faculty Name
</br></br>
<input  type="text" size="40" maxlength="40" name="fname" required>
</br></br>
Mail-id
</br></br>
<input  type="email" size="40"maxlength="30"
name="fmail" required>
</br></br>
<%
out.println("<input style='margin-top:7%;width:45%;padding:0.5% 0.5% 0.5% 0.5%;margin-left:27%; background: rgba(150, 100, 50, 0.3);border: 3px solid black;' type='submit' value='submit'>");
